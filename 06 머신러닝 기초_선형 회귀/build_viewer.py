...
# -*- coding: utf-8 -*-
"""
build_viewer.py for 06 머신러닝 기초_선형 회귀
- 머신러닝 기초 선형 회귀 ipynb 파일과 42개의 AI 해설 마크다운 노트를
...
NOTEBOOK_PATH = os.path.join(WORKSPACE_DIR, "06_머신러닝_기초_선형_회귀.ipynb")
OUTPUT_HTML_PATH = os.path.join(WORKSPACE_DIR, "index06.html")
...
def load_markdown_files():
    ...
    # Mapping of specific file patterns to human-friendly display labels
    label_overrides = {
        "plt.figure_해설_20260921_224601": "plt.figure (8, 5)",
        "plt.subplot_해설_20260921_224620": "plt.subplot (1, 2, 1)",
        "sns.histplot_해설_20260921_224708": "sns.histplot (원본 y)",
        "plt.title_해설_20260921_224728": "plt.title ('원본 y 분포')",
        "plt.xlabel_해설_20260921_224745": "plt.xlabel ('Target Value')",
        "np.log1p_해설_20260921_224814": "np.log1p (y)",
        "plt.subplot_해설_20260921_224834": "plt.subplot (1, 2, 2)",
        "sns.histplot_해설_20260921_224850": "sns.histplot (로그 y_log)",
        "plt.title_해설_20260921_224859": "plt.title ('로그 변환 분포')",
        "plt.xlabel_해설_20260921_224909": "plt.xlabel ('Log Target Value')",
        "plt.tight_layout_해설_20260921_224928": "plt.tight_layout",
        "plt.show_해설_20260921_224944": "plt.show (2단계)",

        "train_test_split_해설_20260921_225002": "train_test_split",
        "X_train.shape_해설_20260921_225026": "X_train.shape",
        "X_test.shape_해설_20260921_225042": "X_test.shape",
        "y_train.shape_해설_20260921_225053": "y_train.shape",
        "y_test.shape_해설_20260921_225103": "y_test.shape",

        "LinearRegression_해설_20260921_225122": "LinearRegression",
        "lr.fit_해설_20260921_225138": "lr.fit (X_train, y_train)",

        "lr.predict_해설_20260921_225204": "lr.predict (X_test)",
        "mean_squared_error_해설_20260921_225216": "mean_squared_error",
        "np.sqrt_해설_20260921_225226": "np.sqrt (RMSE)",
        "plt.figure_해설_20260921_225305": "plt.figure (8, 6)",
        "plt.scatter_해설_20260921_225323": "plt.scatter (실제 vs 예측)",
        "plt.plot_해설_20260921_225334": "plt.plot (기준선 y=x)",
        "plt.xlabel_해설_20260921_225343": "plt.xlabel ('Actual')",
        "plt.ylabel_해설_20260921_225356": "plt.ylabel ('Predicted')",
        "plt.title_해설_20260921_225415": "plt.title ('Actual vs Predicted')",
        "plt.show_해설_20260921_225424": "plt.show (5단계)",

        "np.round_해설_20260921_225505": "np.round (절편 intercept_)",
        "np.round_해설_20260921_225524": "np.round (회귀계수 coef_)",
        "pd.Series_해설_20260921_225602": "pd.Series (계수 시리즈)",
        "coef_series.sort_values_해설_20260921_225613": "coef_series.sort_values",
        "coef_series.index_해설_20260921_225635": "coef_series.index",
        "coef_series.iloc_해설_20260921_225647": "coef_series.iloc"
    }
    ...
    steps_def = [
        {
            ...
            "badge": "준비 단계",
            "title": "라이브러리 Import",
            "summary": "NumPy, Pandas, Matplotlib, Seaborn, Scikit-Learn 등 선형 회귀 분석 및 시각화 필수 패키지 로드",
            "cell_indices": [2, 3]
        },
        {
            "id": "step1",
            ...
            "summary": "Scikit-Learn 당뇨병(load_diabetes) 데이터셋 로드, 특성(X) 및 타깃(y) 분리, DataFrame 변환 및 결측치/타입 확인(df.info)",
            "cell_indices": [4, 5, 6, 7]
        },
        {
            "id": "step2",
            "number": 2,
            "badge": "2단계",
            "title": "타깃 변수 분포 진단 및 로그 변환 (Distribution & Transformation)",
            "summary": "타깃값(y)의 정규분포 여부를 히스토그램으로 확인하고, 왜도 개선을 위한 np.log1p 로그 변환 비교 시각화",
            "cell_indices": [8, 9, 10]
        },
        {
            "id": "step3",
            ...
            "summary": "train_test_split을 사용하여 80:20 비율로 데이터셋을 분할하고 각 데이터 셋의 Shape 및 샘플 값 검증",
            "cell_indices": [11, 12, 13, 14]
        },
        {
            "id": "step4",
            "number": 4,
            "badge": "4단계",
            "title": "선형 회귀 모델 객체 생성 및 학습 (Model Training)",
            "summary": "LinearRegression 객체를 생성하고 fit() 메서드로 학습 데이터를 이용해 최소제곱법(OLS) 기반 최적 회귀선 도출",
            "cell_indices": [15, 16]
        },
        {
            "id": "step5",
            "number": 5,
            "badge": "5단계",
            "title": "테스트 데이터 예측 및 오차 평가 (Prediction & Evaluation)",
            "summary": "predict()로 예측값을 산출하고 MSE 및 RMSE 평가지표 계산, 실제값 vs 예측값 산점도(Scatter Plot) 시각화 비교",
        ...
        },
        {
            ...
            "number": 6,
            "badge": "6단계",
            "title": "회귀 계수 및 절편 분석 (Coefficients & Intercept)",
            "summary": "절편(intercept_)과 각 특성별 가중치(coef_)를 분석하고, 당뇨병 진행에 가장 긍정적/부정적 영향을 미치는 1위 특성 도출",
            "cell_indices": [20, 21]
        }
    ]
...
def map_notes_to_steps(steps, notes):
    ...
    step_file_patterns = {
        "step0": [],
        "step1": ["load_diabetes", "diabetes.data", "diabetes.target", "diabetes.feature_names", "pd.DataFrame", "df.head", "df.info"],
        "step2": [
            "plt.figure_해설_20260921_224601",
            "plt.subplot_해설_20260921_224620",
            "sns.histplot_해설_20260921_224708",
            "plt.title_해설_20260921_224728",
            "plt.xlabel_해설_20260921_224745",
            "np.log1p_해설_20260921_224814",
            "plt.subplot_해설_20260921_224834",
            "sns.histplot_해설_20260921_224850",
            "plt.title_해설_20260921_224859",
            "plt.xlabel_해설_20260921_224909",
            "plt.tight_layout_해설_20260921_224928",
            "plt.show_해설_20260921_224944"
        ],
        "step3": ["train_test_split", "X_train.shape", "X_test.shape", "y_train.shape", "y_test.shape"],
        "step4": ["LinearRegression", "lr.fit"],
        "step5": [
            "lr.predict", "mean_squared_error", "np.sqrt",
            "plt.figure_해설_20260921_225305",
            "plt.scatter", "plt.plot",
            "plt.xlabel_해설_20260921_225343",
            "plt.ylabel",
            "plt.title_해설_20260921_225415",
            "plt.show_해설_20260921_225424"
        ],
        "step6": [
            "np.round_해설_20260921_225505",
            "np.round_해설_20260921_225524",
            "pd.Series", "coef_series.sort_values", "coef_series.index", "coef_series.iloc"
        ]
    }
...
def highlight_code_keywords(code_str, step_notes, step_id):
    ...
    for func in unique_funcs:
        ...
        target_note = next((n for n in step_notes if n["func_name"] == func), None)
...
def generate_viewer_html(steps, notes):
    """
    모든 데이터와 UI/UX 요소를 결합하여 최종 index.html 생성
    """
    steps_nav_html = []
    for s in steps:
    ...
    for s_idx, s in enumerate(steps):
        ...
        for c in s["cells"]:
            ...
            for out in c["outputs"]:
                if out["type"] == "stream":
                    outputs_html.append(f'<div class="output-item stream-output"><div class="output-type-tag">Console Output</div><pre>{out["content"]}</pre></div>')
                elif out["type"] == "html":
                    outputs_html.append(f'<div class="output-item html-table-output"><div class="output-type-tag">Interactive Table / Diagram</div>{out["content"]}</div>')
                elif out["type"] == "image":
                    outputs_html.append(
                        f'<div class="output-item plot-image-output">'
                        f'<div class="output-type-tag">Seaborn / Matplotlib Visual Plot</div>'
                    ...
                    outputs_html.append(f'<div class="output-item text-output"><div class="output-type-tag">Result</div><pre>{out["content"]}</pre></div>')
        ...
        if step_notes:
            ...
            for idx, n in enumerate(step_notes):
                ...
                tab_panes.append(
                    ...
                    f'<button class="jump-to-code-btn" onclick="highlightMatchingKeyword(\'{step_id}\', \'{n["func_name"]}\')">'
                    f'👈 좌측 코드 위치 보기'
                    f'</button>'
                    f'</div>'
                    f'</div>'
            ...
            notes_column_html.append(
                ...
                f'<h3>선형 회귀 필수 환경 및 라이브러리 안내</h3>'
                f'<p>이 단계에서는 회귀 분석 모델링 및 시각화에 필요한 파이썬 필수 라이브러리와 폰트 환경을 준비합니다.</p>'
                f'<div class="lib-cards-grid">'
                f'<div class="lib-card"><strong>koreanize-matplotlib</strong>: Matplotlib 한글 폰트 깨짐 현상을 원클릭으로 자동 해결해 주는 필수 패키지</div>'
                f'<div class="lib-card"><strong>sklearn.datasets.load_diabetes</strong>: 442명 당뇨병 환자의 건강 지표와 질병 진행도를 담은 표준 회귀용 벤치마크 데이터셋</div>'
                f'<div class="lib-card"><strong>sklearn.linear_model.LinearRegression</strong>: 최소제곱법(OLS)을 사용하여 독립변수와 종속변수 간의 최적 선형 관계식을 학습하는 회귀 모델</div>'
                f'<div class="lib-card"><strong>sklearn.model_selection.train_test_split</strong>: 과적합(Overfitting) 방지를 위해 데이터를 학습용(Train)과 평가용(Test)으로 분리하는 도구</div>'
                f'<div class="lib-card"><strong>sklearn.metrics.mean_squared_error</strong>: 실제값과 예측값의 오차 제곱 평균(MSE)을 계산하여 모델 성능을 수치화하는 지표</div>'
                f'<div class="lib-card"><strong>seaborn & matplotlib</strong>: 타깃값 분포 확인 및 실제값 vs 예측값 산점도(Scatter Plot) 시각화 도구</div>'
                f'</div>'
                f'</div>'
                f'</div>'
            )
...
<head>
  ...
  <title>머신러닝 기초: 선형 회귀 (Linear Regression) 인터랙티브 듀얼 뷰어</title>
...
<body>
    ...
    <div class="header-main-bar">
      <div class="brand-wrap">
        ...
        <div class="brand-titles">
          <h1>머신러닝 기초: 선형 회귀 (Linear Regression)</h1>
          <p>
            <span>인터랙티브 듀얼 학습 뷰어</span>
            <span class="stats-pill">7개 파이프라인 단계</span>
            <span class="stats-pill">{total_notes_count}개 AI 해설 노트 연결</span>
          </p>
        </div>
      </div>
      ...
      <div class="header-actions">
        ...
        <div class="search-box-wrap">
          ...
          <input type="text" id="global-search" class="search-input" placeholder="함수 검색 (ex: LinearRegression, predict...)" oninput="filterFunctions(this.value)" />
        </div>
  ...
  <script>
    function toggleTheme() {{
      ...
      localStorage.setItem('study_theme_06', next);
    ...
    (function initTheme() {{
      const saved = localStorage.getItem('study_theme_06') || localStorage.getItem('study_theme');
      if (saved) {{
    ...
    function highlightMatchingKeyword(stepId, funcName) {{
      const stepElem = document.getElementById(stepId);
      if (!stepElem) return;
...
"""
    ...
    print(f"성공적으로 index.html 파일이 생성되었습니다: {OUTPUT_HTML_PATH}")
    print(f"   - 총 단계: {len(steps)}개")
    print(f"   - 총 해설 노트: {len(notes)}개")


def main():
    print("머신러닝 선형 회귀 인터랙티브 듀얼 뷰어 빌더 시작...")
