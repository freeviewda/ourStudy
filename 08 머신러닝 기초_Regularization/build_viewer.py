...
# -*- coding: utf-8 -*-
"""
build_viewer.py for 08 머신러닝 기초_Regularization
- 머신러닝 기초 선형 회귀 규제(Ridge, Lasso, ElasticNet) ipynb 파일과 39개의 AI 해설 마크다운 노트를
...
NOTEBOOK_PATH = os.path.join(WORKSPACE_DIR, "08_머신러닝_기초_Regularization.ipynb")
OUTPUT_HTML_PATH = os.path.join(WORKSPACE_DIR, "index08.html")
...
def load_markdown_files():
    ...
    label_overrides = {
        # 1단계: 데이터 로드 및 분할
        "load_diabetes_해설_20260922_145714": "load_diabetes (return_X_y)",
        "train_test_split_해설_20260922_145728": "train_test_split (8:2 분할)",

        # 2단계: 데이터 스케일링
        "StandardScaler_해설_20260922_145746": "StandardScaler (정규화 객체)",
        "scaler.fit_transform_해설_20260922_145803": "scaler.fit_transform (학습셋)",
        "scaler.transform_해설_20260922_145825": "scaler.transform (테스트셋)",

        # 3단계: Ridge (L2 정규화)
        "Ridge_해설_20260922_145843": "Ridge (L2 정규화 모델)",
        "ridge.fit_해설_20260922_145902": "ridge.fit (모델 학습)",
        "ridge.predict_해설_20260922_145940": "ridge.predict (예측값 산출)",
        "mean_squared_error_해설_20260922_145955": "mean_squared_error (Ridge MSE)",
        "np.round_해설_20260922_150034": "np.round (Ridge 가중치 축소)",

        # 4단계: Lasso (L1 정규화) - 1차 실행 해설
        "Lasso_해설_20260922_150049": "Lasso (L1 정규화 - 1)",
        "lasso.fit_해설_20260922_150059": "lasso.fit (1)",
        "lasso.predict_해설_20260922_150114": "lasso.predict (1)",
        "mean_squared_error_해설_20260922_150127": "MSE (Lasso - 1)",
        "np.sum_해설_20260922_150140": "np.sum (선택된 특성 수 - 1)",
        "np.round_해설_20260922_150158": "np.round (0 계수 확인 - 1)",
        "X.shape_해설_20260922_150216": "X.shape (전체 특성 수 - 1)",

        # 4단계: Lasso (L1 정규화) - 2차 실행 해설
        "Lasso_해설_20260922_150230": "Lasso (L1 정규화 - 2)",
        "lasso.fit_해설_20260922_150244": "lasso.fit (2)",
        "lasso.predict_해설_20260922_150305": "lasso.predict (2)",
        "mean_squared_error_해설_20260922_150319": "MSE (Lasso - 2)",
        "np.sum_해설_20260922_150331": "np.sum (선택된 특성 수 - 2)",
        "np.round_해설_20260922_150351": "np.round (0 계수 확인 - 2)",
        "X.shape_해설_20260922_150401": "X.shape (전체 특성 수 - 2)",

        # 5단계: Elastic-Net (L1 + L2)
        "ElasticNet_해설_20260922_150415": "ElasticNet (L1+L2 혼합 모델)",
        "elastic_net.fit_해설_20260922_150426": "elastic_net.fit (모델 학습)",
        "elastic_net.predict_해설_20260922_150439": "elastic_net.predict (예측값 산출)",
        "mean_squared_error_해설_20260922_150448": "mean_squared_error (ElasticNet MSE)",
        "elastic_net.coef__해설_20260922_150504": "elastic_net.coef_ (혼합 가중치)",

        # 6단계: 규제 모델별 회귀 계수 비교 시각화
        "plt.figure_해설_20260922_150518": "plt.figure (차트 크기 6x4)",
        "plt.plot_해설_20260922_150530": "plt.plot (Ridge L2 계수선)",
        "plt.plot_해설_20260922_150539": "plt.plot (Lasso L1 계수선)",
        "plt.plot_해설_20260922_150554": "plt.plot (ElasticNet 계수선)",
        "plt.axhline_해설_20260922_150605": "plt.axhline (y=0 기준선)",
        "plt.title_해설_20260922_150614": "plt.title (비교 그래프 제목)",
        "plt.xlabel_해설_20260922_150623": "plt.xlabel ('Features')",
        "plt.ylabel_해설_20260922_150629": "plt.ylabel ('Coefficient Value')",
        "plt.legend_해설_20260922_150642": "plt.legend (모델 범례 표시)",
        "plt.show_해설_20260922_150652": "plt.show (시각화 출력)"
    }
    ...
    steps_def = [
        {
            ...
            "summary": "NumPy, Pandas, Matplotlib, Seaborn, Scikit-Learn 등 규제 선형 회귀(Ridge, Lasso, ElasticNet) 분석 및 전처리 필수 패키지 로드",
            "cell_indices": [2, 3]
        },
        {
            "id": "step1",
            "number": 1,
            "badge": "1단계",
            "title": "데이터 로드 및 분할 (Data Loading & Train-Test Split)",
            "summary": "load_diabetes를 통한 당뇨병 데이터셋(X, y) 로드 및 train_test_split(80:20)을 활용한 학습용/테스트용 데이터 분할",
            "cell_indices": [4, 5]
        },
        {
            "id": "step2",
            "number": 2,
            "badge": "2단계",
            "title": "데이터 스케일링 (StandardScaler Feature Scaling)",
            "summary": "규제 모델(L1/L2 패널티)의 공정한 가중치 적용을 위해 StandardScaler를 학습 데이터 기준으로 적합(fit_transform) 및 테스트 데이터 변환(transform)",
            "cell_indices": [6, 7]
        },
        {
            "id": "step3",
            "number": 3,
            "badge": "3단계",
            "title": "모델 학습 및 평가: Ridge (L2 정규화 - 가중치 축소)",
            "summary": "L2 릿지(Ridge, alpha=1.0) 모델을 학습하고 MSE 오차 측정, 모든 변수의 계수가 0이 되지 않고 축소(Shrinkage)되는 특성 분석",
            "cell_indices": [8, 9]
        },
        {
            "id": "step4",
            "number": 4,
            "badge": "4단계",
            "title": "모델 학습 및 평가: Lasso (L1 정규화 - 특성 선택)",
            "summary": "L1 라쏘(Lasso, alpha=1.0) 모델을 학습하고 MSE 오차 측정, 불필요한 특성의 계수를 0으로 만들어 자동 변수 선택(Feature Selection)하는 특성 분석",
        ...
        },
        {
            ...
            "number": 5,
            "badge": "5단계",
            "title": "모델 학습 및 평가: Elastic-Net (L1 + L2 혼합 정규화)",
            "summary": "L1(Lasso)과 L2(Ridge)의 장점을 결합한 ElasticNet(alpha=0.1, l1_ratio=0.5) 모델 학습, MSE 오차 및 회귀 계수 산출",
            "cell_indices": [13, 14]
        },
        {
            "id": "step6",
            "number": 6,
            "badge": "6단계",
            "title": "규제 모델별 회귀 계수 비교 시각화 (Coefficients Comparison Plot)",
            "summary": "Ridge, Lasso, ElasticNet 세 모델의 특성별 회귀 계수(coef_)를 Matplotlib 꺾은선 그래프와 기준선(y=0)으로 시각화 비교 분석",
            "cell_indices": [15]
        }
    ]
    ...
    for sdef in steps_def:
        ...
        for idx in sdef["cell_indices"]:
            if idx < len(all_cells):
                ...
                if not source.strip() and ctype == "code":
                    continue
                ...
                for out in c.get("outputs", []):
                    ...
                    if otype == "stream":
                        ...
                        if "Collecting koreanize-matplotlib" in text or "koreanize-matplotlib in" in text:
                            continue
...
def map_notes_to_steps(steps, notes):
    ...
    step_file_patterns = {
        "step0": [],
        "step1": [
            "load_diabetes_해설_20260922_145714",
            "train_test_split_해설_20260922_145728"
        ],
        "step2": [
            "StandardScaler_해설_20260922_145746",
            "scaler.fit_transform_해설_20260922_145803",
            "scaler.transform_해설_20260922_145825"
        ],
        "step3": [
            "Ridge_해설_20260922_145843",
            "ridge.fit_해설_20260922_145902",
            "ridge.predict_해설_20260922_145940",
            "mean_squared_error_해설_20260922_145955",
            "np.round_해설_20260922_150034"
        ],
        "step4": [
            "Lasso_해설_20260922_150049",
            "lasso.fit_해설_20260922_150059",
            "lasso.predict_해설_20260922_150114",
            "mean_squared_error_해설_20260922_150127",
            "np.sum_해설_20260922_150140",
            "np.round_해설_20260922_150158",
            "X.shape_해설_20260922_150216",
            "Lasso_해설_20260922_150230",
            "lasso.fit_해설_20260922_150244",
            "lasso.predict_해설_20260922_150305",
            "mean_squared_error_해설_20260922_150319",
            "np.sum_해설_20260922_150331",
            "np.round_해설_20260922_150351",
            "X.shape_해설_20260922_150401"
        ],
        "step5": [
            "ElasticNet_해설_20260922_150415",
            "elastic_net.fit_해설_20260922_150426",
            "elastic_net.predict_해설_20260922_150439",
            "mean_squared_error_해설_20260922_150448",
            "elastic_net.coef__해설_20260922_150504"
        ],
        "step6": [
            "plt.figure_해설_20260922_150518",
            "plt.plot_해설_20260922_150530",
            "plt.plot_해설_20260922_150539",
            "plt.plot_해설_20260922_150554",
            "plt.axhline_해설_20260922_150605",
            "plt.title_해설_20260922_150614",
            "plt.xlabel_해설_20260922_150623",
            "plt.ylabel_해설_20260922_150629",
            "plt.legend_해설_20260922_150642",
            "plt.show_해설_20260922_150652"
        ]
    }
...
def highlight_code_keywords(code_str, step_notes, step_id):
    ...
    for func in unique_funcs:
        ...
        target_note = matching_notes[0] if matching_notes else None
...
def generate_viewer_html(steps, notes):
    """
    모든 데이터와 UI/UX 요소를 결합하여 최종 index08.html 생성
    """
    steps_nav_html = []
    for s in steps:
    ...
    for s_idx, s in enumerate(steps):
            ...
            for out in c["outputs"]:
                if out["type"] == "stream":
                    ...
                    outputs_html.append(
                        ...
                        f'<div class="output-type-tag">Matplotlib Visualization Plot (규제 회귀 계수 비교)</div>'
        ...
        if step_notes:
            ...
            notes_column_html.append(
                ...
                f'<h3>선형 회귀 규제(Regularization) 필수 라이브러리 안내</h3>'
                f'<p>이 단계에서는 과적합(Overfitting)과 다중공선성을 방지하기 위한 정규화 선형 모델 및 스케일링 패키지를 로드합니다.</p>'
                f'<div class="lib-cards-grid">'
                f'<div class="lib-card"><strong>koreanize-matplotlib</strong>: 차트 및 시각화 작성 시 한글 폰트 깨짐 현상을 원클릭으로 자동 방지해 주는 필수 유틸리티</div>'
                f'<div class="lib-card"><strong>sklearn.preprocessing.StandardScaler</strong>: 특성들의 단위(Scale) 차이로 인해 특정 가중치에만 과도한 페널티가 부여되는 것을 방지하기 위한 표준정규분포 스케일러</div>'
                f'<div class="lib-card"><strong>sklearn.linear_model.Ridge</strong>: L2 놈(Norm) 페널티를 부여하여 가중치를 0에 가깝게 축소(Shrinkage)시키는 릿지 회귀 모델</div>'
                f'<div class="lib-card"><strong>sklearn.linear_model.Lasso</strong>: L1 놈(Norm) 페널티를 부여하여 덜 중요한 특성의 가중치를 정확히 0으로 만들어 자동 변수 선택을 수행하는 라쏘 회귀 모델</div>'
                f'<div class="lib-card"><strong>sklearn.linear_model.ElasticNet</strong>: L1과 L2 정규화의 비율(l1_ratio)을 조절하여 두 방식의 장점을 상호 보완한 엘라스틱넷 모델</div>'
                f'<div class="lib-card"><strong>matplotlib.pyplot</strong>: 세 가지 규제 모델의 특성별 회귀 계수 크기를 꺾은선 그래프와 기준선으로 한눈에 비교하는 시각화 모듈</div>'
                f'</div>'
                f'</div>'
                f'</div>'
            )
...
<head>
  ...
  <title>머신러닝 기초: 선형 회귀 규제 (Regularization: Ridge, Lasso, ElasticNet) 인터랙티브 듀얼 뷰어</title>
...
<body>
    ...
    <div class="header-main-bar">
      <div class="brand-wrap">
        ...
        <div class="brand-titles">
          <h1>머신러닝 기초: 선형 회귀 규제 (Regularization)</h1>
          <p>
            <span>인터랙티브 듀얼 학습 뷰어</span>
            <span class="stats-pill">7개 파이프라인 단계 (준비+6단계)</span>
            <span class="stats-pill">{total_notes_count}개 AI 상세 해설 노트 연결</span>
            <span class="stats-pill">Ridge (L2) · Lasso (L1) · ElasticNet · StandardScaler</span>
          </p>
        </div>
      </div>
      ...
      <div class="header-actions">
        ...
        <div class="search-box-wrap">
          ...
          <input type="text" id="global-search" class="search-input" placeholder="함수 검색 (ex: Ridge, Lasso, coef_...)" oninput="filterFunctions(this.value)" />
        </div>
  ...
  <script>
    function toggleTheme() {{
      ...
      localStorage.setItem('study_theme_08', next);
    ...
    (function initTheme() {{
      const saved = localStorage.getItem('study_theme_08') || localStorage.getItem('study_theme');
      if (saved) {{
...
"""
    ...
    print(f"성공적으로 index08.html 파일이 생성되었습니다: {OUTPUT_HTML_PATH}")
    print(f"   - 총 단계: {len(steps)}개")
    print(f"   - 총 해설 노트: {len(notes)}개")


def main():
    print("머신러닝 선형 회귀 규제(Regularization) 인터랙티브 듀얼 뷰어 빌더 시작...")
